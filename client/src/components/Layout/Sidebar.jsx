...
const Sidebar = () => {
  ...
  const ventasSections = [
    { path: '/facturacion', icon: ShoppingCart, label: 'Nueva Factura' },
    { path: '/historial-ventas', icon: Receipt, label: 'Historial' },
  ...
  const configSections = [
    { path: '/configuracion/negocio', icon: Building2, label: 'Negocio' },
